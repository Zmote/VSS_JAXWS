...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements ch.hsr.vss.w04.CalculatorService {
    ...
    private java.lang.String Calculator_address = "http://localhost:9090/JAXWS/services/Calculator";
    ...
    public ch.hsr.vss.w04.Calculator getCalculator() throws javax.xml.rpc.ServiceException {
    ...
    public ch.hsr.vss.w04.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ch.hsr.vss.w04.CalculatorSoapBindingStub _stub = new ch.hsr.vss.w04.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ch.hsr.vss.w04.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                ch.hsr.vss.w04.CalculatorSoapBindingStub _stub = new ch.hsr.vss.w04.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://w04.vss.hsr.ch", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://w04.vss.hsr.ch", "Calculator"));
        }
