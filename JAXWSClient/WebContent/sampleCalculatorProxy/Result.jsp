...
<jsp:useBean id="sampleCalculatorProxyid" scope="session" class="ch.hsr.vss.w04.CalculatorProxy" />
<%
...
case 10:
        gotMethod = true;
        ch.hsr.vss.w04.Calculator getCalculator10mtemp = sampleCalculatorProxyid.getCalculator();
...
case 20:
        ...
        int divide20mtemp = sampleCalculatorProxyid.divide(a_3idTemp,b_4idTemp);
...
case 27:
        ...
        int subtract27mtemp = sampleCalculatorProxyid.subtract(a_5idTemp,b_6idTemp);
        String tempResultreturnp28 = org.eclipse.jst.ws.util.JspUtils.markup(String.valueOf(subtract27mtemp));
        %>
        <%= tempResultreturnp28 %>
        <%
break;
case 34:
        ...
        int multiply34mtemp = sampleCalculatorProxyid.multiply(a_7idTemp,b_8idTemp);
        String tempResultreturnp35 = org.eclipse.jst.ws.util.JspUtils.markup(String.valueOf(multiply34mtemp));
        %>
        <%= tempResultreturnp35 %>
        <%
break;
